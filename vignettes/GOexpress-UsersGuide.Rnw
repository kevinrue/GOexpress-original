...
In this example, we search for GO terms enriched in genes that cluster best the
...
the clustering of the predefined groups of samples; genes that cluster samples
